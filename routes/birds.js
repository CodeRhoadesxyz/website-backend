...
// --- Public: list adoptable birds ---
// By default excludes 'adopted' birds (this is the adoptable-birds listing,
// not a "success stories" page) and only-published ones. The admin dashboard
// calls this same route with ?all=1 to see everything, including drafts and
// adopted birds — same convention already used by the events route.
router.get('/', (req, res) => {
...
router.patch('/:id', requireAdmin, (req, res) => {
  ...
  for (const field of fields) {
    if (field in (req.body || {})) {
      ...
      // has to be converted to 0/1 here.
