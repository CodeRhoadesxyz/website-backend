(function () {
  ...
  window.RescueWidgets.renderForm(containerId, {
    ...
    fields: [
      ...
      { name: 'Age', label: "Bird's age (approximate)", required: false },
      { name: 'Health', label: 'Current health / behavioral notes', type: 'textarea', required: false },
      { name: 'Reason', label: 'Reason for relinquishment', type: 'textarea', required: true },
    ],
  });
})();
